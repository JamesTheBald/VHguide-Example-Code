...
const setAdviceAndRelateds = (contentIDTemp, setAdvice, setRelated, log, log2) => {
  ...
  log2 && console.log("setAdviceAndRelated.js runs. contentPersonasBI[contID]=", contentPersonasBI[contentIDTemp]);
  log2 && console.log("setAdviceAndRelated.js runs. contentPersonasBI[contID].advice=", contentPersonasBI[contentIDTemp].advice);
