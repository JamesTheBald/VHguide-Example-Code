...
export const medExemptOverviewTheySayContent = [
  // <>
  // apostrophe'  &apos; or just '
  ...
  {
    subheading: <>&ldquo;My mental health is suffering&rdquo;</>,
    quotes: [
      <>
        I'm totally isolated because I'm not vaccinated. I can't do anything with anybody anymore. I want to be able to
        present an exemption letter because my mental health is in the crapper. Is my mental health not a legitimate
        medical concern?
      </>,
    ],
  },
  {
    subheading: <>&ldquo;It's all politics, it's an infringement&rdquo;</>,
    quotes: [
      <>
        I got my right to be able to go off and do what I need to do, and I am not going to have somebody tell me how to
        do this.
      </>,
    ],
  },
  {
    subheading: <>&ldquo;It's against my religion&rdquo;</>,
    quotes: [
      <>
        I am opposed to any injection with ingredients that may create the possibility of long-term adverse effects such
        as COVID-19. This goes against my religious beliefs and teachings.
      </>,
      <>
  ...
  {
    subheading: <>&ldquo;I am allergic to the vaccines&rdquo;</>,
    quotes: [
  ...
  {
    subheading: <>&ldquo;Do me a favour&rdquo;</>,
    quotes: [
      <>
  ...
  {
    subheading: <>&ldquo;I'm pregnant/worried about fertility&rdquo;</>,
    quotes: [
      <>
