...

              {
                text: (
                  <>
                    ...
                    few, different options as you want. 50 years ago with a car, you just took whatever car you got. his
                    technology is all about being nimble and responding to the variants.
                  </>
                ),
                featured: false,
                image: "",
...

              {
                text: (
                  <>
                    ...
                    research on this right now, there are trials ongoing. They are not ignoring the anecdotes, or trying
                    to suppress research &ndash; let&apos;s just wait until that research is done before we start taking
                    unapproved drugs.
                  </>
                ),
                featured: false,
...

              {
                text: (
                  <>
                    ...
                    unfiltered. Any bad thing that happened to anyone, a week or six weeks after they got a vaccine gets
                    put in there. If you take 100,000 people at random, don&apos;t give them a vaccine, just say &apos;
                    <i>Okay today&apos;s the day we&apos;re going to pay attention to you</i>,&apos; I guarantee 30,000
                    of them within a day or two are going to have a sniffle, a headache, a miscarriage, something. If
                    you follow 100,000 people over time, something is bound to happen randomly. Or if it isn&apos;t
                    randomly, it certainly doesn&apos;t have anything to do with the thing you said you were paying
                    attention to. What this means is that a lot of the information on those sites is noise. The reason
                    it&apos;s collected is to see if there&apos;s a pattern developing out of the noise. Not, &apos;did
                    somebody somewhere have this after a vaccine,&apos; but &apos;did more people in a given week who
                    got the vaccine have this than people who didn&apos;t get the vaccine.&apos;
                  </>
                ),
...

              {
                text: (
                  <>
                    ...
                    controlled studies on it. There&apos;s a reason we don&apos;t prescribe it for COVID, and it&apos;s
                    because it doesn&apos;t work. There have been a dozen studies. At most, a couple of them have shown,
                    kind of, maybe, sort of, if-you-squint-you-can-see-a-shape in the cloud, that Ivermectin might help.
                    A little. Most of them have found no benefit. I mean if you&apos;re really determined to believe it
                    would help, you can jigg the numbers and can sort of convince yourself, but you&apos;re looking for
                    shapes in the clouds. And why look in the clouds for signs when the vaccine works and is safe?
                    They&apos;re both medicine. They&apos;re both an intervention from outside. But one of them
                    definitely works and the other, well, you&apos;re looking at clouds.
                  </>
                ),
      ...
      takeHome: {
        ...
        content: [
          ...
          <>
            ...
            immunization room as comfortable and supportive as possible. Spending even an extra 10 minutes with someone
...

              {
                text: (
                  <>
                    ...
                    &ldquo;Well, I can go 100km&#47;h in a school zone because I&apos;m probably not going to get caught
                    and I&apos;m a free person. Those little kids down there, well, they just have to take
                    responsibility for themselves!&rdquo; You can say that, but the fact is you might get caught &ndash;
                    you might get sick. The fact is, we live in a society where people have give up some freedoms to be
                    part of the group. We have speed zones in schools because we&apos;re trying to protect the kids
                    &ndash; the next generation of us &ndash; because they&apos;re not that savvy yet. With COVID,
                    we&apos;re all taking our shots so we can keep our kids safe, creating a kind of &lsquo;school
                    zone&rsquo; by reducing the amount of virus in the community because they can&apos;t get the
                    vaccines yet.
                  </>
                ),
                featured: false,
