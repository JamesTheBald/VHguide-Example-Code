  ...
  redTapemRNA: {
    ...
    text: (
      <>
        ...
        is kind of tricky because you have to have enough people sick with [a disease] in order to study
        [the vaccines].
        <br />
        <br />
        ...
        researching, then asking another question, researching &mdash; we were able to ask a whole bunch of questions at
        ...
        <br />
        <br />
        Also &mdash; we started producing vaccine in the factory before we even knew for sure it was going to work. And
        so as soon as we knew it was going to work, we could start giving the [vaccines] out. Whereas
        usually we&apos;d have to wait a year or two for them to make the vaccine.
        <br />
        <br />
        ...
        from this and [we should] maybe think about how we need to approve things moving forward and not
        have it be so darn slow.
      </>
    ),
  },
  ...
  quickDevelopment: {
    ...
    text: (
      <>
        ...
        ideas and parts they needed to build the vaccine were ready and waiting for them. All that work had
        already been done. So they had a running start and they had vast sums of money and time.
        <br />
        <br />
        It actually makes me kind of angry that they could do what they did with this vaccine [e.g. developing
        them so quickly, distributing globally], but they haven&apos;t done the same thing for TB? Why don&apos;t
        they do this for malaria? Now, that we know this is possible, I want to see them do it for all sorts of
        conditions that are killing people who are under-resourced. But as far as these vaccines go, I don&apos;t
        necessarily need you to trust them, but I do think you should trust me. These are good vaccines. They stop
        people from dying from the virus.
      </>
    ),
  },
