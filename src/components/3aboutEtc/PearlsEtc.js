...
import PearlsPanels from "./PearlsPanels";

const PearlsEtc = props => {
  ...
  return (
    <div className={showContactForm ? "fixed" : ""}>
      <div className="stdMargins flex flex-col">
        <h1 className="titleFont titleBig z-30" style={{ marginTop: yDistTitleFromTop }}>
          {pageTitle}
        </h1>

        {path.match(/pearls/i) && (
          <div className="mt-4 mb-2  text-blue-black text-16 sm:text-18">
