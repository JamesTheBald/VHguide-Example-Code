  ...
  return (
    ...
    >
      ...
      <div className="w-full stdMargins  flex flex-col lg:flex-row  z-20 relative" style={{ zIndex: 20 }}>
        ...
        <div
          name="Container for Main Graphic"
          className="order-first lg:order-last  lg:w-1/2 lg:flex lg:justify-center"
        >
          <DisplayGatsbyDynImage
            queryArray={homepagePics}
            fileName={mainImageFileName}
            wrapClass="mxs:mt-4 lg:ml-8 mxl:ml-12 xl:ml-16  mr-4  lg:mb-10
                       w-64 mxs:w-72 sm:w-90 md:w-110 lg:w-11/12 mxl:w-5/6 max-w-160 xxl:max-w-180"
            // lg:w-150 xl:w-190
